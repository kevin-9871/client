...
module.exports = __webpack_require__("O+54");
...
/* harmony import */ var _lib_utils__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__("NsEo");
/* harmony import */ var src_services__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__("CLrh");
...
/* harmony import */ var _redux_galleries_actions__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__("MNxK");
/* harmony import */ var _redux_user_actions__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__("x7is");
/* harmony import */ var react_infinite_scroller__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__("WLqv");
...
/* harmony import */ var src_components_performer_assets_common_modal_buy_assets__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__("04bX");
/* harmony import */ var _components_galleries_gallery_card__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__("xRqz");
...
class GalleriesPage extends react__WEBPACK_IMPORTED_MODULE_3__["PureComponent"] {
  static async getInitialProps({
    ...
    try {
      ...
      if (query.username) {
        const resp = await src_services__WEBPACK_IMPORTED_MODULE_5__[/* performerService */ "k"].details(query.username);
        return {
          performer: resp.data
        };
      }
  ...
  async getGalleries() {
    ...
    try {
      ...
      antd__WEBPACK_IMPORTED_MODULE_0__["message"].error(Object(_lib_utils__WEBPACK_IMPORTED_MODULE_4__[/* getResponseError */ "h"])(err));
    }
  }
  ...
  async loadMore() {
    try {
      ...
      const performerId = performer ? performer._id : '';
      offset = limit + offset;
      const resp = await src_services__WEBPACK_IMPORTED_MODULE_5__[/* galleryService */ "e"].search(_objectSpread(_objectSpread({}, query), {}, {
        performerId,
        limit,
        offset
      }), false);
  ...
  render() {
    ...
    return __jsx(react__WEBPACK_IMPORTED_MODULE_3___default.a.Fragment, null, __jsx(next_head__WEBPACK_IMPORTED_MODULE_2___default.a, null, __jsx("title", null, performer !== null && performer !== void 0 && performer.username ? `${performer === null || performer === void 0 ? void 0 : performer.username}'s ` : '', "Galleries", ' ')), __jsx("div", {
      ...
      title: `${performer !== null && performer !== void 0 && performer.username ? `${performer === null || performer === void 0 ? void 0 : performer.username}'s ` : ''}
            Galleries`
    }), query.username && !performer && __jsx(antd__WEBPACK_IMPORTED_MODULE_0__["Alert"], {
      message: "Performer not found.",
      banner: true
    }), __jsx("div", {
      className: "galleries-page"
    }, searching ? __jsx("p", null, "Loading...") : success ? __jsx(react_infinite_scroller__WEBPACK_IMPORTED_MODULE_10___default.a, {
      ...
      gutter: 20
    }, ids && ids.length > 0 ? ids.map(id => data[id].numOfItems > 0 && __jsx(antd__WEBPACK_IMPORTED_MODULE_0__["Col"], {
      xl: 4,
      md: 6,
      sm: 8,
      xs: 24,
      key: id
    }, __jsx(_components_galleries_gallery_card__WEBPACK_IMPORTED_MODULE_12__[/* default */ "a"], {
      gallery: data[id],
      onHandlePurchase: this.purchase.bind(this)
    }))) : __jsx("p", {
      className: "no-items-found"
    }, "No gallery found."))) : __jsx("p", null, "Server error")), __jsx(src_components_performer_assets_common_modal_buy_assets__WEBPACK_IMPORTED_MODULE_11__[/* default */ "a"], _extends({
...
_defineProperty(GalleriesPage, "authentica", false);

_defineProperty(GalleriesPage, "layout", 'public');
...
const mapDispatchs = {
  getPerformerGalleries: _redux_galleries_actions__WEBPACK_IMPORTED_MODULE_8__[/* getPerformerGalleries */ "b"],
  addPerformerGalleries: _redux_galleries_actions__WEBPACK_IMPORTED_MODULE_8__[/* addPerformerGalleries */ "a"],
  updateCurrentUserBalance: _redux_user_actions__WEBPACK_IMPORTED_MODULE_9__[/* updateCurrentUserBalance */ "o"],
  purchaseGallerySuccess: _redux_galleries_actions__WEBPACK_IMPORTED_MODULE_8__[/* purchaseGallerySuccess */ "f"]
};
/* harmony default export */ __webpack_exports__["default"] = (Object(next_router__WEBPACK_IMPORTED_MODULE_7__["withRouter"])(Object(react_redux__WEBPACK_IMPORTED_MODULE_6__["connect"])(mapStates, mapDispatchs)(GalleriesPage)));
