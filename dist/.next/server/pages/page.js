...
module.exports = __webpack_require__("oa3P");
...
/* harmony import */ var _services_post_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__("Co7z");
...
class PostDetail extends react__WEBPACK_IMPORTED_MODULE_3__["PureComponent"] {
  constructor(props) {
    super(props);
    this.state = {
      fetching: false,
  ...
  async getPost() {
    ...
    try {
      ...
      const resp = await _services_post_service__WEBPACK_IMPORTED_MODULE_4__[/* postService */ "a"].findById(id);
      this.setState({
        post: resp.data
      });
    } catch (e) {
      const error = await Promise.resolve(e);
      antd__WEBPACK_IMPORTED_MODULE_1__["message"].error(Object(src_lib__WEBPACK_IMPORTED_MODULE_7__[/* getResponseError */ "j"])(error));
    } finally {
      this.setState({
        fetching: false
      });
  ...
  render() {
    ...
    return __jsx(react__WEBPACK_IMPORTED_MODULE_3___default.a.Fragment, null, __jsx(next_head__WEBPACK_IMPORTED_MODULE_0___default.a, null, __jsx("title", null, post && post.title)), fetching && __jsx(_components_common_base_loader__WEBPACK_IMPORTED_MODULE_6__[/* default */ "a"], {
      spinning: true,
      fullScreen: true
    }), __jsx("div", {
...
/* harmony default export */ __webpack_exports__["default"] = (Object(react_redux__WEBPACK_IMPORTED_MODULE_5__["connect"])(mapProps)(PostDetail));
