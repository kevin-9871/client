...
module.exports = __webpack_require__("k1O3");
...
/* harmony import */ var _index_less__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__("V/Nr");
...
/* harmony import */ var _components_common_layout_numberformat__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__("TXU+");
...
const FormGallery = ({
  ...
  const [uploading, setUploading] = react__WEBPACK_IMPORTED_MODULE_0___default.a.useState(false);
  const [fileList, setFileList] = react__WEBPACK_IMPORTED_MODULE_0___default.a.useState([]);

  if (gallery !== null && gallery !== void 0 && gallery.token && !src_lib__WEBPACK_IMPORTED_MODULE_4__[/* unitPrices */ "n"].find(p => p.value === gallery.token)) {
    src_lib__WEBPACK_IMPORTED_MODULE_4__[/* unitPrices */ "n"].push({
      value: gallery.token,
      text: __jsx(_components_common_layout_numberformat__WEBPACK_IMPORTED_MODULE_8__[/* default */ "a"], {
        value: gallery.token,
        suffix: " tokens"
      })
    });
  ...
  const [tokens, setTokenPrice] = react__WEBPACK_IMPORTED_MODULE_0___default.a.useState(src_lib__WEBPACK_IMPORTED_MODULE_4__[/* unitPrices */ "n"]);
  ...
  const formInput = [{
    ...
    children: __jsx(antd__WEBPACK_IMPORTED_MODULE_1__["Checkbox"], null, "Is sale Gallery?")
  }, {
    fieldKey: 'tokenPrice',
    label: 'Token',
    dependencies,
    children: () => __jsx(antd__WEBPACK_IMPORTED_MODULE_1__["Form"].Item, {
      name: "token",
      ...
      dropdownRender: menu => __jsx("div", null, menu, __jsx(antd__WEBPACK_IMPORTED_MODULE_1__["Divider"], {
        dashed: true
      }), __jsx(antd__WEBPACK_IMPORTED_MODULE_1__["Space"], null, __jsx(antd__WEBPACK_IMPORTED_MODULE_1__["Input"], {
    ...
    name: 'status',
    label: 'Status',
    children: __jsx(antd__WEBPACK_IMPORTED_MODULE_1__["Radio"].Group, null, PERFORMER_GALLERY_STATUS.map(status => __jsx(antd__WEBPACK_IMPORTED_MODULE_1__["Radio"], {
      value: status.key,
      key: status.key
    }, status.name)))
  }];
  ...
  const searchGalleryPhoto = async () => {
    try {
      if (gallery._id) {
        const resp = await src_services__WEBPACK_IMPORTED_MODULE_6__[/* photoService */ "l"].search({
  ...
  const handleUploadPhotos = async () => {
    ...
    if (!fileList || !fileList.length) {
      antd__WEBPACK_IMPORTED_MODULE_1__["message"].error('Please select photo!');
      return;
    }
    ...
    if (!uploadFiles.length) {
      antd__WEBPACK_IMPORTED_MODULE_1__["message"].error('Please select new file!');
      return;
    }
    ...
    try {
      const resp = await Promise.all(uploadFiles.map(file => src_services__WEBPACK_IMPORTED_MODULE_6__[/* photoService */ "l"].uploadImages(file.originFileObj, data, onUploading)));
  ...
  const handleChange = async ({
    ...
    const files = await Promise.all(fl.filter(file => file.status !== 'done').map(file => Object(src_lib__WEBPACK_IMPORTED_MODULE_4__[/* getBase64 */ "i"])(file.originFileObj, 'uploading', file)));
  ...
  const onRemove = async file => {
    try {
      setUploading(true);
      await src_services__WEBPACK_IMPORTED_MODULE_6__[/* photoService */ "l"].remove(file.uid);
      antd__WEBPACK_IMPORTED_MODULE_1__["message"].success('Removed!');
    } catch (e) {
      const err = await Promise.resolve(e);
      antd__WEBPACK_IMPORTED_MODULE_1__["message"].error(Object(src_lib__WEBPACK_IMPORTED_MODULE_4__[/* getResponseError */ "j"])(err));
  ...
  return __jsx(antd__WEBPACK_IMPORTED_MODULE_1__["Form"], _extends({}, src_lib__WEBPACK_IMPORTED_MODULE_4__[/* formItemLayout */ "e"], {
    form: form,
    onFinish: onFinish,
    ...
    fields: formInput
  }), gallery._id && __jsx(antd__WEBPACK_IMPORTED_MODULE_1__["Upload"], {
    accept: "image/*",
    multiple: true,
    showUploadList: true,
    onPreview: onPreview,
  ...
  }, __jsx(_ant_design_icons__WEBPACK_IMPORTED_MODULE_2__["PlusOutlined"], null), __jsx("div", {
    className: "ant-upload-text"
  }, "Upload")))), __jsx(antd__WEBPACK_IMPORTED_MODULE_1__["Form"].Item, src_lib__WEBPACK_IMPORTED_MODULE_4__[/* tailFormItemLayout */ "m"], __jsx(antd__WEBPACK_IMPORTED_MODULE_1__["Space"], null, __jsx(antd__WEBPACK_IMPORTED_MODULE_1__["Button"], {
    type: "primary",
    htmlType: "submit",
    disabled: loading,
    loading: loading
...
/* harmony default export */ __webpack_exports__["a"] = (FormGallery);
...
/* harmony import */ var _components_photos_gallery_form__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__("CZXo");
/* harmony import */ var src_services__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__("CLrh");
...
/* harmony import */ var _error__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__("D4/9");
/* harmony import */ var _index_less__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__("3xR3");
...
class UpdatePerformerGalleryPage extends react__WEBPACK_IMPORTED_MODULE_0__["PureComponent"] {
  static async getInitialProps({
    ...
    try {
      ...
      const resp = await src_services__WEBPACK_IMPORTED_MODULE_6__[/* galleryService */ "e"].details(id, {
        Authorization: token
      });
      return {
        gallery: resp.data
  ...
  async onFinish(data) {
    ...
    try {
      ...
      await src_services__WEBPACK_IMPORTED_MODULE_6__[/* galleryService */ "e"].update(gallery._id, _objectSpread(_objectSpread({}, data), {}, {
        performerId: performer._id
      }));
      antd__WEBPACK_IMPORTED_MODULE_1__["message"].success('Update gallery success.');
    } catch (e) {
      this.showError(e);
    } finally {
      this.setState({
  ...
  async remove(id) {
    try {
      await src_services__WEBPACK_IMPORTED_MODULE_6__[/* photoService */ "l"].remove(id);
      antd__WEBPACK_IMPORTED_MODULE_1__["message"].success('Removed!');
    } catch (e) {
      this.showError(e);
    }
  ...
  render() {
    ...
    if (!gallery) return __jsx(_error__WEBPACK_IMPORTED_MODULE_9__["default"], {
      statusCode: 404
    });
    const {
      onSubmit
    } = this.state;
    return __jsx(react__WEBPACK_IMPORTED_MODULE_0___default.a.Fragment, null, __jsx(next_head__WEBPACK_IMPORTED_MODULE_3___default.a, null, __jsx("title", null, "Update Gallery", ' ', gallery && gallery.name)), __jsx("div", {
    ...
    }), __jsx(_components_photos_gallery_form__WEBPACK_IMPORTED_MODULE_5__[/* default */ "a"], {
      loading: onSubmit,
      performer: performer,
...
_defineProperty(UpdatePerformerGalleryPage, "authenticate", true);

_defineProperty(UpdatePerformerGalleryPage, "layout", 'primary');

const mapStateToProps = state => ({
  performer: state.performer.current
});

/* harmony default export */ __webpack_exports__["default"] = (Object(react_redux__WEBPACK_IMPORTED_MODULE_4__["connect"])(mapStateToProps)(UpdatePerformerGalleryPage));
