...
/* harmony import */ var _components_photos_photo_form__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__("pKnN");
...
/* harmony import */ var _error__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__("D4/9");
/* harmony import */ var _index_less__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__("M6VO");
...
class UpdatePerformerPhotoPage extends react__WEBPACK_IMPORTED_MODULE_0__["PureComponent"] {
  static async getInitialProps({
    ...
    try {
      ...
      const resp = await src_services__WEBPACK_IMPORTED_MODULE_6__[/* photoService */ "l"].details(id, {
        Authorization: token
      });
      return {
        photo: resp.data
  ...
  async onFinish(data) {
    ...
    try {
      ...
      await src_services__WEBPACK_IMPORTED_MODULE_6__[/* photoService */ "l"].update(`/performer/performer-assets/photos/${photo._id}`, _objectSpread(_objectSpread({}, data), {}, {
        performerId: performer._id
      }));
      antd__WEBPACK_IMPORTED_MODULE_1__["message"].success('Update photo success.');
  ...
  render() {
    ...
    if (!photo) return __jsx(_error__WEBPACK_IMPORTED_MODULE_10__["default"], {
      statusCode: 404
    });
    const {
      onSubmit
    } = this.state;
    return __jsx(react__WEBPACK_IMPORTED_MODULE_0___default.a.Fragment, null, __jsx(next_head__WEBPACK_IMPORTED_MODULE_3___default.a, null, __jsx("title", null, "Update Photo")), __jsx("div", {
      className: "performer-photos-page"
    }, __jsx(_components_common_layout_page_header__WEBPACK_IMPORTED_MODULE_2__[/* default */ "a"], {
      title: "Update a Photo"
    }), __jsx(_components_photos_photo_form__WEBPACK_IMPORTED_MODULE_5__[/* default */ "a"], {
      loading: onSubmit,
...
_defineProperty(UpdatePerformerPhotoPage, "authenticate", true);

_defineProperty(UpdatePerformerPhotoPage, "layout", 'primary');

const mapStateToProps = state => ({
  performer: state.performer.current
});

/* harmony default export */ __webpack_exports__["default"] = (Object(react_redux__WEBPACK_IMPORTED_MODULE_4__["connect"])(mapStateToProps)(UpdatePerformerPhotoPage));
...
module.exports = __webpack_require__("05cE");
...
// CONCATENATED MODULE: ./src/components/common/base/select/galleries.tsx
...
const Galleries = ({
  ...
  const [galleries, setGalleries] = external_react_["useState"]([]);
  const [galleryId, setGalleryId] = external_react_["useState"](defaultGalleryId);

  const getGalleryList = async (q = '') => {
    try {
      const resp = await services["e" /* galleryService */].search({
        q
      });
...
/* harmony default export */ var select_galleries = (Galleries);
// EXTERNAL MODULE: ./src/lib/index.ts + 2 modules
var lib = __webpack_require__("psLn");
...
// EXTERNAL MODULE: ./src/components/photos/index.less
var photos = __webpack_require__("V/Nr");

// CONCATENATED MODULE: ./src/components/photos/photo-form.tsx
var photo_form_jsx = external_react_default.a.createElement;
...
const FormPhoto = ({
  ...
  const formInput = [{
    ...
    children: photo_form_jsx(external_antd_["Input"], {
    ...
    rules: [{
      required: true,
      message: 'please select photo gallery'
    }],
    children: photo_form_jsx(select_galleries, {
      form: form,
      defaultGalleryId: photo.galleryId
    })
  }, {
    name: 'description',
    label: 'Description',
    children: photo_form_jsx(external_antd_["Input"].TextArea, {
      placeholder: "Title Description"
    })
  }, {
    name: 'status',
    label: 'Status',
    children: photo_form_jsx(external_antd_["Radio"].Group, null, PERFORMER_PHOTO_STATUS.map(status => photo_form_jsx(external_antd_["Radio"], {
      value: status.key,
      key: status.key
    }, status.name)))
  }];
  const [file, setFile] = external_react_default.a.useState(photo.photo ? photo.photo.url : null);
  ...
  return photo_form_jsx(external_antd_["Form"], _extends({}, lib["e" /* formItemLayout */], {
    form: form,
    onFinish: onFinish,
    name: "photoCreatingForm",
    initialValues: _objectSpread(_objectSpread({}, initialValues), photo),
    layout: "vertical"
  }), photo_form_jsx(input_item_list["a" /* default */], {
    fields: formInput
  }), photo_form_jsx(external_antd_["Form"].Item, {
    name: "photo",
    label: "Photo File"
  }, photo_form_jsx(external_antd_["Upload"], {
    showUploadList: false,
    accept: "image/*",
    customRequest: () => true,
    onChange: onFileChange
  }, photo_form_jsx(external_antd_["Button"], null, photo_form_jsx(icons_["UploadOutlined"], null), ' ', "Upload File"))), file && photo_form_jsx(external_antd_["Form"].Item, null, photo_form_jsx("img", {
    src: file,
    style: imageStyle,
    alt: ""
  })), photo_form_jsx(external_antd_["Form"].Item, lib["m" /* tailFormItemLayout */], photo_form_jsx(external_antd_["Space"], null, photo_form_jsx(external_antd_["Button"], {
    type: "primary",
    htmlType: "submit",
    disabled: loading,
    loading: loading
  }, "Save Changes"), photo_form_jsx(external_antd_["Button"], {
    type: "primary",
...
/* harmony default export */ var photo_form = __webpack_exports__["a"] = (FormPhoto);
