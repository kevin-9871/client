...
module.exports = __webpack_require__("36JD");
...
/* harmony import */ var _index_less__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__("M6VO");
...
class CreatePerformerPhotoPage extends react__WEBPACK_IMPORTED_MODULE_0__["PureComponent"] {
  constructor(props) {
    super(props);
    this.state = {
      onSubmit: false
  ...
  async onFinish(data) {
    ...
    try {
      ...
      await src_services__WEBPACK_IMPORTED_MODULE_6__[/* photoService */ "l"].create('/performer/performer-assets/photos/upload', _objectSpread(_objectSpread({}, data), {}, {
        performerId: performer._id
      }));
      antd__WEBPACK_IMPORTED_MODULE_1__["message"].success('Add photo success.');
  ...
  render() {
    ...
    return __jsx(react__WEBPACK_IMPORTED_MODULE_0___default.a.Fragment, null, __jsx(next_head__WEBPACK_IMPORTED_MODULE_3___default.a, null, __jsx("title", null, "Upload Photo")), __jsx("div", {
...
_defineProperty(CreatePerformerPhotoPage, "authenticate", true);

_defineProperty(CreatePerformerPhotoPage, "layout", 'primary');

const mapStateToProps = state => ({
  performer: state.performer.current
});

/* harmony default export */ __webpack_exports__["default"] = (Object(react_redux__WEBPACK_IMPORTED_MODULE_4__["connect"])(mapStateToProps)(CreatePerformerPhotoPage));
