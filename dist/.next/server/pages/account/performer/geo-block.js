...
module.exports = __webpack_require__("a0d4");
...
/* harmony import */ var _lib_utils__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__("NsEo");
/* harmony import */ var react_redux__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__("h74D");
/* harmony import */ var react_redux__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(react_redux__WEBPACK_IMPORTED_MODULE_6__);
/* harmony import */ var _index_less__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__("n4iA");
...
class PerformerGeoBlockPage extends react__WEBPACK_IMPORTED_MODULE_3__["PureComponent"] {
  constructor(props) {
    super(props);
    this.state = {
      blockedCountries: [],
  ...
  async handleBlockUser(userId) {
    ...
    try {
      ...
      src_services__WEBPACK_IMPORTED_MODULE_4__[/* performerService */ "k"].geoBlock({
        userIds: blockedUsers.length ? blockedUsers.map(b => b._id) : []
      });
    } catch (e) {
      const error = await Promise.resolve(e);
      antd__WEBPACK_IMPORTED_MODULE_0__["message"].error(error || 'Something went wrong, please try again later');
    }
  }
  ...
  async search() {
    try {
      ...
      const resp = await src_services__WEBPACK_IMPORTED_MODULE_4__[/* performerService */ "k"].getBlockedList();
      this.setState({
      ...
      const error = await Promise.resolve(e);
      antd__WEBPACK_IMPORTED_MODULE_0__["message"].error(Object(_lib_utils__WEBPACK_IMPORTED_MODULE_5__[/* getResponseError */ "h"])(error || 'An error occurred, please try again!'));
    } finally {
      this.setState({
        isLoading: false
      });
  ...
  async blockCountry(blockedCountries) {
    try {
      await src_services__WEBPACK_IMPORTED_MODULE_4__[/* performerService */ "k"].geoBlock({
  ...
  render() {
    ...
    const countriesColumns = [{
      ...
      dataIndex: 'code',
      key: 'check',
      render: code => __jsx(antd__WEBPACK_IMPORTED_MODULE_0__["Checkbox"], {
        disabled: isBlocking,
    ...
    const usersColumns = [{
      ...
      dataIndex: '_id',
      key: 'check',
      render: id => __jsx("div", null, __jsx(antd__WEBPACK_IMPORTED_MODULE_0__["Button"], {
        onClick: this.handleBlockUser.bind(this, id)
      }, "Unblock"))
    }];
    return __jsx(react__WEBPACK_IMPORTED_MODULE_3___default.a.Fragment, null, __jsx(next_head__WEBPACK_IMPORTED_MODULE_2___default.a, null, __jsx("title", null, "Blocking")), __jsx("div", {
    ...
    }, __jsx(antd__WEBPACK_IMPORTED_MODULE_0__["Tabs"].TabPane, {
      tab: "GEO Blocking",
      key: "geo-block"
    }, __jsx("div", null, countries && countries.length > 0 && !isLoading ? __jsx(antd__WEBPACK_IMPORTED_MODULE_0__["Table"], {
      pagination: false,
    ...
    }, "loading..."))), __jsx(antd__WEBPACK_IMPORTED_MODULE_0__["Tabs"].TabPane, {
      tab: "Black list users",
      key: "user-block"
    }, __jsx("div", null, !isLoading ? __jsx(antd__WEBPACK_IMPORTED_MODULE_0__["Table"], {
      pagination: false,
...
/* harmony default export */ __webpack_exports__["default"] = (Object(react_redux__WEBPACK_IMPORTED_MODULE_6__["connect"])(mapStateToProps)(PerformerGeoBlockPage));
