...
/* harmony import */ var _index_less__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__("FWAC");
...
class CreatePerformerVideosPage extends react__WEBPACK_IMPORTED_MODULE_0__["PureComponent"] {
  static async getInitialProps({
    ...
    try {
      ...
      const resp = await src_services__WEBPACK_IMPORTED_MODULE_6__[/* videoService */ "v"].details(id, {
        Authorization: token
      });
      return {
        video: resp.data
  ...
  async onFinish(data) {
    ...
    try {
      ...
      await src_services__WEBPACK_IMPORTED_MODULE_6__[/* videoService */ "v"].update(`/performer/performer-assets/videos/${video._id}`, _objectSpread(_objectSpread({}, data), {}, {
        performerId: performer._id
      }));
      antd__WEBPACK_IMPORTED_MODULE_1__["message"].success('Update video success.');
    } catch (e) {
  ...
  render() {
    ...
    if (!video) return __jsx(_error__WEBPACK_IMPORTED_MODULE_9__["default"], {
      statusCode: 404
    });
    const {
      onSubmit
    } = this.state;
    return __jsx(react__WEBPACK_IMPORTED_MODULE_0___default.a.Fragment, null, __jsx(next_head__WEBPACK_IMPORTED_MODULE_3___default.a, null, __jsx("title", null, "Update Video -", video && video.title)), __jsx("div", {
...
module.exports = __webpack_require__("+bA6");
