...
module.exports = __webpack_require__("VjcE");
...
/* harmony import */ var _index_less__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__("/B2y");
...
class PayoutRequestCreatePage extends react__WEBPACK_IMPORTED_MODULE_0___default.a.PureComponent {
  ...
  async submit(data) {
    ...
    try {
      ...
      await src_services__WEBPACK_IMPORTED_MODULE_6__[/* payoutRequestService */ "i"].create(body);
      antd__WEBPACK_IMPORTED_MODULE_3__["message"].success('Create Success!');
      next_router__WEBPACK_IMPORTED_MODULE_7___default.a.push('/account/performer/payout-requests');
    } catch (e) {
  ...
  render() {
    ...
    return __jsx(react__WEBPACK_IMPORTED_MODULE_0___default.a.Fragment, null, __jsx(next_head__WEBPACK_IMPORTED_MODULE_1___default.a, null, __jsx("title", null, "Payout Request")), __jsx("div", {
