...
module.exports = __webpack_require__("ftXo");
...
// CONCATENATED MODULE: ./src/components/galleries/gallery-dashboard-grid.tsx
...
const Dashboard = ({
  ...
  title: title,
  bordered: false
}, !searching ? success && (data.length > 0 ? data.map(gallery => __jsx(external_antd_["Card"].Grid, {
  className: "photo-box",
  key: gallery._id
}, __jsx("div", {
...
}, __jsx(icons_["EditOutlined"], null)), __jsx(trash["a" /* default */], {
  confirm: () => remove(gallery._id)
})), renderActiveTag(gallery.status), renderSale(gallery.isSale, gallery.token)), __jsx("div", {
  className: "photo-info"
}, __jsx("span", null, Object(string["a" /* capitalizeFirstLetter */])(gallery.name)), __jsx("span", null, gallery.numOfItems, ' ', "Items")), __jsx("div", {
  className: "photo-description"
}, "Created On", ' ', Object(lib["f" /* formatDate */])(gallery.createdAt, 'DD MMMM YYYY')), __jsx("div", {
  className: "photo-description"
}, gallery.description))) : __jsx("p", null, "No items")) : __jsx("p", null, "Loading...")), error && __jsx(external_antd_["Alert"], {
  type: "error",
...
/* harmony default export */ var gallery_dashboard_grid = (Dashboard);
// EXTERNAL MODULE: ./pages/account/performer/galleries/index.less
var performer_galleries = __webpack_require__("3xR3");

// EXTERNAL MODULE: ./src/services/index.ts + 13 modules
var services = __webpack_require__("CLrh");

// CONCATENATED MODULE: ./pages/account/performer/galleries/index.tsx
var galleries_jsx = external_react_default.a.createElement;
...
class galleries_PerformerPhotoPage extends external_react_["PureComponent"] {
  constructor(props) {
    super(props);
    this.state = {
      limit: 12,
  ...
  async onRemove(id) {
    ...
    try {
      await services["e" /* galleryService */].remove(id);
  ...
  async addGalleries() {
    ...
    try {
      ...
      offset = limit + offset;
      const resp = await services["l" /* photoService */].myPhotos(_objectSpread(_objectSpread({}, this.state), {}, {
        offset
      }));
  ...
  render() {
    ...
    return galleries_jsx(external_react_default.a.Fragment, null, galleries_jsx(head_default.a, null, galleries_jsx("title", null, "My Galleries")), galleries_jsx("div", {
      className: "performer-gallries-page"
    }, galleries_jsx(page_header["a" /* default */], {
      title: "Galleries",
      extra: galleries_jsx(external_antd_["Space"], null, galleries_jsx(external_antd_["Button"], {
        type: "primary",
        onClick: () => router_default.a.push('/account/performer/galleries/add')
      }, "Add a new photo gallery"), galleries_jsx(external_antd_["Button"], {
        type: "primary",
        onClick: () => router_default.a.push('/account/performer/photos/add')
      }, "Add a new photo"))
    }), galleries_jsx(gallery_dashboard_grid, galleriesGridProps)));
  }

}

_defineProperty(galleries_PerformerPhotoPage, "authenticate", true);

_defineProperty(galleries_PerformerPhotoPage, "layout", 'primary');

const mapStateToProps = state => _objectSpread({}, state.performer.assets.galleries);

const mapDispatchs = {
  getMyPhotos: actions["k" /* getMyPhotos */],
  removeMyPhoto: actions["D" /* removeMyPhoto */],
  addMyPhotos: actions["b" /* addMyPhotos */],
  getMyGalleries: actions["h" /* getMyGalleries */],
  removeMyGalleries: actions["C" /* removeMyGalleries */],
  addMyGalleries: actions["a" /* addMyGalleries */]
};
/* harmony default export */ var account_performer_galleries = __webpack_exports__["default"] = (Object(external_react_redux_["connect"])(mapStateToProps, mapDispatchs)(galleries_PerformerPhotoPage));
