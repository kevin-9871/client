...
module.exports = __webpack_require__("P4Vn");
...
/* harmony import */ var _services_product_service__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__("HR6+");
...
/* harmony import */ var _index_less__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__("KptR");
...
class PerformerProductsPage extends react__WEBPACK_IMPORTED_MODULE_0__["PureComponent"] {
  static async getInitialProps({
    ...
    try {
      ...
      const resp = await _services_product_service__WEBPACK_IMPORTED_MODULE_8__[/* productService */ "a"].details(id, {
        Authorization: token
      });
      return {
        product: resp.data
  ...
  async onFinish(data) {
    ...
    try {
      ...
      await _services_perfomer_service__WEBPACK_IMPORTED_MODULE_6__[/* performerService */ "b"].updateProduct(`/performer/performer-assets/products/${product._id}`, _objectSpread(_objectSpread({}, data), {}, {
        performerId: performer._id
      }));
      antd__WEBPACK_IMPORTED_MODULE_1__["message"].success('Update product success.');
    } catch (e) {
  ...
  render() {
    ...
    if (!product) return __jsx(_error__WEBPACK_IMPORTED_MODULE_10__["default"], {
      statusCode: 404
    });
    const {
      onSubmit
    } = this.state;
    return __jsx(react__WEBPACK_IMPORTED_MODULE_0___default.a.Fragment, null, __jsx(next_head__WEBPACK_IMPORTED_MODULE_3___default.a, null, __jsx("title", null, "Update Product -", ' ', product && product.name)), __jsx("div", {
...
/* harmony default export */ __webpack_exports__["default"] = (Object(react_redux__WEBPACK_IMPORTED_MODULE_4__["connect"])(mapStateToProps)(PerformerProductsPage));
