...
module.exports = __webpack_require__("GPi1");
...
// CONCATENATED MODULE: ./src/components/transaction/table-list.tsx
...
const TransactionHistoryTable = ({
  ...
  const columns = [{
    ...
    render(date) {
      return __jsx("span", null, Object(lib["f" /* formatDate */])(date));
    }
...
// EXTERNAL MODULE: ./pages/account/user/transaction-history/index.less
var transaction_history = __webpack_require__("1PdN");

// CONCATENATED MODULE: ./pages/account/user/transaction-history/index.tsx
var transaction_history_jsx = external_react_default.a.createElement;
...
class transaction_history_TransactionHistoryPage extends external_react_["PureComponent"] {
  constructor(props) {
    super(props);
    this.state = {
      loading: true,
  ...
  async onChange(pagination, filters, sorter) {
    ...
    await this.setState(Object(utils["i" /* getSearchData */])(pagination, filters, sorter, oldState));
    this.getData();
  }
  ...
  async getData() {
    ...
    try {
      const resp = await services["t" /* transactionService */].search(_objectSpread(_objectSpread({}, filter), {}, {
        limit,
        offset,
        sortBy,
        sort
  ...
  render() {
    ...
    return transaction_history_jsx(external_react_default.a.Fragment, null, transaction_history_jsx(head_default.a, null, transaction_history_jsx("title", null, "Transaction History")), transaction_history_jsx("div", {
      className: "transaction-history-page"
    }, transaction_history_jsx(page_header["a" /* default */], {
      title: "Transaction History"
    }), transaction_history_jsx("div", null, loading ? transaction_history_jsx(loader["a" /* default */], null) : transaction_history_jsx(TransactionHistoryTable, {
      rowKey: "_id",
...
_defineProperty(transaction_history_TransactionHistoryPage, "authenticate", true);

_defineProperty(transaction_history_TransactionHistoryPage, "layout", 'primary');

/* harmony default export */ var user_transaction_history = __webpack_exports__["default"] = (transaction_history_TransactionHistoryPage);
