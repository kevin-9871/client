...
module.exports = __webpack_require__("f48x");
...
/* harmony import */ var _index_less__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__("qMdF");
...
class PaymentTokenHistory extends react__WEBPACK_IMPORTED_MODULE_0__["PureComponent"] {
  ...
  async onChange(pagination, filters, sorter) {
    ...
    await this.setState(Object(_lib_utils__WEBPACK_IMPORTED_MODULE_3__[/* getSearchData */ "i"])(pagination, filters, sorter, oldState));
    this.getData();
  }

  async onDateChange(_, dateStrings) {
    const oldState = this.state;
    await this.setState(_objectSpread(_objectSpread({}, oldState), {}, {
  ...
  async getData() {
    const query = Object(lodash__WEBPACK_IMPORTED_MODULE_9__["omit"])(this.state, ['data', 'total', 'loading']);
    await this.setState({
      searching: true
    });

    try {
      const resp = await src_services__WEBPACK_IMPORTED_MODULE_8__[/* productService */ "n"].purchased(_objectSpread({}, query));
      await this.setState({
  ...
  async showError(e) {
    ...
    antd__WEBPACK_IMPORTED_MODULE_5__["message"].error(Object(_lib_utils__WEBPACK_IMPORTED_MODULE_3__[/* getResponseError */ "h"])(err));
  }
  ...
  render() {
    ...
    return __jsx(react__WEBPACK_IMPORTED_MODULE_0___default.a.Fragment, null, __jsx(next_head__WEBPACK_IMPORTED_MODULE_4___default.a, null, __jsx("title", null, "My Purchased Products")), __jsx("div", {
