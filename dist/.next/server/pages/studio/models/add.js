...
module.exports = __webpack_require__("uJgb");
...
// CONCATENATED MODULE: ./src/components/studio/models-manager/studio-add-model-form.tsx
...
const StudioAddModelForm = ({
  ...
  return __jsx(external_antd_["Form"], {
  ...
  })), error && __jsx(external_antd_["Form"].Item, null, __jsx(external_antd_["Alert"], {
    description: Object(utils["h" /* getResponseError */])(message),
    type: "error",
    message: "Error"
  })), __jsx(external_antd_["Form"].Item, {
    style: {
    ...
    type: "primary",
    onClick: () => router_default.a.push('/studio/models'),
    className: "btn-submit"
  }, "Cancel"), __jsx(external_antd_["Button"], {
    type: "primary",
    htmlType: "submit",
    loading: loading,
    disabled: loading,
...
/* harmony default export */ var studio_add_model_form = (StudioAddModelForm);
...
// CONCATENATED MODULE: ./pages/studio/models/add.tsx
...
class add_StudioAddModel extends external_react_["PureComponent"] {
  constructor(...args) {
    super(...args);
  ...
  async onFinish(data) {
    ...
    try {
      ...
      await services["s" /* studioService */].addModel(data);
      external_antd_["message"].success('Added successfully');
      dispatchUpdateTotalPerformer(1);
      router_default.a.push('/studio/models');
    } catch (e) {
      const error = await Promise.resolve(e);
      this.setState({
        error: true,
        message: Object(utils["h" /* getResponseError */])(error)
      });
    } finally {
      this.setState({
        loading: false
  ...
  render() {
    ...
    return add_jsx(external_react_default.a.Fragment, null, add_jsx(head_default.a, null, add_jsx("title", null, "Add New Member")), add_jsx("div", {
      className: "studio-models-background"
    }, add_jsx(page_header["a" /* default */], {
      title: ""
    }), add_jsx("div", {
      className: "studio-models-box"
    }, add_jsx(studio_add_model_form, {
...
_defineProperty(add_StudioAddModel, "authenticate", true);

_defineProperty(add_StudioAddModel, "layout", 'primary');

/* harmony default export */ var add = __webpack_exports__["default"] = (Object(external_react_redux_["connect"])(null, {
  updateTotalPerformer: actions["J" /* updateTotalPerformer */]
})(add_StudioAddModel));
