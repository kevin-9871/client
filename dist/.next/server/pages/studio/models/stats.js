...
module.exports = __webpack_require__("vO+l");
...
// CONCATENATED MODULE: ./src/components/studio/models-manager/studio-models-stats-table.tsx
...
const StudioModelStatsTable = ({
  ...
  const columns = [{
    ...
    render: record => {
      ...
      return Object(lib["b" /* converDuration */])((record === null || record === void 0 ? void 0 : (_record$stats6 = record.stats) === null || _record$stats6 === void 0 ? void 0 : _record$stats6.totalStreamTime) || 0);
    }
  }, {
    title: 'Total Earned',
...
/* harmony default export */ var studio_models_stats_table = (StudioModelStatsTable);
...
// CONCATENATED MODULE: ./pages/studio/models/stats.tsx
var stats_jsx = external_react_default.a.createElement;

function stats_ownKeys(object, enumerableOnly) { var keys = Object.keys(object); if (Object.getOwnPropertySymbols) { var symbols = Object.getOwnPropertySymbols(object); if (enumerableOnly) { symbols = symbols.filter(function (sym) { return Object.getOwnPropertyDescriptor(object, sym).enumerable; }); } keys.push.apply(keys, symbols); } return keys; }

function stats_objectSpread(target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i] != null ? arguments[i] : {}; if (i % 2) { stats_ownKeys(Object(source), true).forEach(function (key) { stats_defineProperty(target, key, source[key]); }); } else if (Object.getOwnPropertyDescriptors) { Object.defineProperties(target, Object.getOwnPropertyDescriptors(source)); } else { stats_ownKeys(Object(source)).forEach(function (key) { Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key)); }); } } return target; }
...
class stats_StudioModelStatsPage extends external_react_["PureComponent"] {
  constructor(props) {
    super(props);
    this.state = {
      limit: 12,
  ...
  handleTableChange(pagination, filters, sorter) {
    const state = stats_objectSpread({}, this.state);

    this.setState(Object(lib["k" /* getSearchData */])(pagination, filters, sorter, state));
  }
  ...
  render() {
    ...
    return stats_jsx(external_react_default.a.Fragment, null, stats_jsx(head_default.a, null, stats_jsx("title", null, "Performer Stats")), stats_jsx("div", {
      className: "studio-models-background"
    }, stats_jsx(page_header["a" /* default */], {
      title: "Models"
    }), stats_jsx("div", {
      className: "studio-models-box"
    }, stats_jsx(external_antd_["Row"], null, stats_jsx(external_antd_["Col"], {
      xs: 24,
      sm: 12
    }, stats_jsx(search_online_status["a" /* default */], {
      searching: searching,
      onSearch: this.onSearch.bind(this)
    })), stats_jsx(external_antd_["Col"], {
      xs: 24,
      sm: 12
    })), stats_jsx(studio_models_stats_table, {
      data: data,
      searching: searching,
      total: total,
...
stats_defineProperty(stats_StudioModelStatsPage, "authenticate", 'studio');

stats_defineProperty(stats_StudioModelStatsPage, "layout", 'primary');

const mapStateToProps = state => stats_objectSpread({}, state.studio.members);

const mapDispatchs = {
  getMembers: actions["a" /* getMembers */]
};
/* harmony default export */ var stats = __webpack_exports__["default"] = (Object(external_react_redux_["connect"])(mapStateToProps, mapDispatchs)(stats_StudioModelStatsPage));
