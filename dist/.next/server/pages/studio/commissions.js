...
module.exports = __webpack_require__("hp9R");
...
// CONCATENATED MODULE: ./src/components/studio/models-manager/studio-commissions-table.tsx
...
const StudioCommissionsTable = ({
  ...
  const columns = [{
    ...
    render(createdAt) {
      return __jsx("span", null, Object(lib["f" /* formatDate */])(createdAt));
    }
    ...
    key: 'actions',
    dataIndex: '_id',
    render: _id => __jsx(external_antd_["Button"], {
      type: "primary",
      onClick: () => update(_id)
    }, "Update")
  }];
...
/* harmony default export */ var studio_commissions_table = (StudioCommissionsTable);
// EXTERNAL MODULE: external "react-redux"
var external_react_redux_ = __webpack_require__("h74D");

// EXTERNAL MODULE: ./pages/studio/commissions/index.less
var commissions = __webpack_require__("YFSQ");

// EXTERNAL MODULE: ./src/components/common/base/popup.tsx
var popup = __webpack_require__("Acen");

// EXTERNAL MODULE: ./src/services/index.ts + 13 modules
var services = __webpack_require__("CLrh");

// CONCATENATED MODULE: ./pages/studio/commissions/index.tsx
var commissions_jsx = external_react_default.a.createElement;

function commissions_ownKeys(object, enumerableOnly) { var keys = Object.keys(object); if (Object.getOwnPropertySymbols) { var symbols = Object.getOwnPropertySymbols(object); if (enumerableOnly) { symbols = symbols.filter(function (sym) { return Object.getOwnPropertyDescriptor(object, sym).enumerable; }); } keys.push.apply(keys, symbols); } return keys; }

function commissions_objectSpread(target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i] != null ? arguments[i] : {}; if (i % 2) { commissions_ownKeys(Object(source), true).forEach(function (key) { commissions_defineProperty(target, key, source[key]); }); } else if (Object.getOwnPropertyDescriptors) { Object.defineProperties(target, Object.getOwnPropertyDescriptors(source)); } else { commissions_ownKeys(Object(source)).forEach(function (key) { Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key)); }); } } return target; }

function commissions_defineProperty(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }
...
class commissions_StudioModelsPage extends external_react_["PureComponent"] {
  constructor(props) {
    super(props);

    commissions_defineProperty(this, "popupRef", void 0);

    commissions_defineProperty(this, "inputRef", void 0);
  ...
  async onOk() {
    ...
    try {
      ...
      await services["s" /* studioService */].updateMemberCommission(commissionId, parseInt(value, 10));
  ...
  render() {
    ...
    return commissions_jsx(external_react_default.a.Fragment, null, commissions_jsx(head_default.a, null, commissions_jsx("title", null, "Commissions")), commissions_jsx(popup["a" /* default */], {
      ref: ref => this.popupRef = ref,
      content: commissions_jsx(external_antd_["Input"], {
        type: "number",
        min: 0,
        max: 100,
    ...
    }, commissions_jsx(page_header["a" /* default */], {
      title: "Commissions"
    }), commissions_jsx("div", {
      className: "studio-commisson-box"
    }, commissions_jsx(studio_commissions_table, {
      data: data,
      searching: searching,
      total: total,
...
commissions_defineProperty(commissions_StudioModelsPage, "authenticate", 'studio');

commissions_defineProperty(commissions_StudioModelsPage, "layout", 'primary');

const mapStateToProps = state => commissions_objectSpread({}, state.studio.commissions);

const mapDispatchs = {
  getMembersCommissions: actions["b" /* getMembersCommissions */],
  updateMemberCommision: actions["A" /* updateMemberCommision */]
};
/* harmony default export */ var studio_commissions = __webpack_exports__["default"] = (Object(external_react_redux_["connect"])(mapStateToProps, mapDispatchs)(commissions_StudioModelsPage));
