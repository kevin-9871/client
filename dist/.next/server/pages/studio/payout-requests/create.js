...
/* harmony import */ var _index_less__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__("5AzW");
...
class PayoutRequestCreatePage extends react__WEBPACK_IMPORTED_MODULE_0___default.a.PureComponent {
  ...
  async submit(data) {
    ...
    try {
      ...
      await src_services__WEBPACK_IMPORTED_MODULE_5__[/* payoutRequestService */ "i"].create(body, 'studio');
      antd__WEBPACK_IMPORTED_MODULE_3__["message"].success('Create Success!');
      next_router__WEBPACK_IMPORTED_MODULE_6___default.a.push('/studio/payout-requests');
    } catch (e) {
...
module.exports = __webpack_require__("2iXE");
