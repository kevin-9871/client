...
module.exports = __webpack_require__("m26M");
...
// CONCATENATED MODULE: ./src/components/payout-request/studio-performer-request-table.tsx
...
class studio_performer_request_table_StatusTitle extends external_react_["PureComponent"] {
  render() {
    return __jsx(icons_["EditOutlined"], null);
  }
...
const EditableCell = _ref => {
  ...
  const [editing, setEditing] = external_react_["useState"](false);
  ...
  if (editable) {
    childNode = editing ? __jsx(external_antd_["Select"], {
...
const PayoutRequestList = ({
  ...
  const [dataSource, setDataSource] = external_react_["useState"]([]);
  const columns = [{
    title: 'Name',
    key: 'q',
    ...
    render: ({
      fromDate,
      toDate
    }) => __jsx("span", null, Object(lib["f" /* formatDate */])(fromDate, format), ' ', "-", Object(lib["f" /* formatDate */])(toDate, format)),
    editable: false
  }, {
    ...
    dataIndex: 'status',
    key: 'status',
    render: status => __jsx(external_antd_["Tag"], {
      color: "magenta",
      style: {
        cursor: 'pointer'
      }
    ...
    key: 'createdAt',
    dataIndex: 'createdAt',
    render: createdAt => __jsx("span", null, Object(lib["f" /* formatDate */])(createdAt)),
    sorter: true,
    editable: false
  }];
  ...
  const save = async request => {
    try {
      await services["s" /* studioService */].updateStatusPerformerRequest(request._id, {
...
/* harmony default export */ var studio_performer_request_table = (PayoutRequestList);
// EXTERNAL MODULE: ./src/lib/utils.ts
var utils = __webpack_require__("NsEo");

// EXTERNAL MODULE: ./pages/studio/payout-requests/index.less
var payout_requests = __webpack_require__("5AzW");

// CONCATENATED MODULE: ./pages/studio/payout-requests/performer-requests.tsx
var performer_requests_jsx = external_react_default.a.createElement;

function performer_requests_ownKeys(object, enumerableOnly) { var keys = Object.keys(object); if (Object.getOwnPropertySymbols) { var symbols = Object.getOwnPropertySymbols(object); if (enumerableOnly) { symbols = symbols.filter(function (sym) { return Object.getOwnPropertyDescriptor(object, sym).enumerable; }); } keys.push.apply(keys, symbols); } return keys; }

function performer_requests_objectSpread(target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i] != null ? arguments[i] : {}; if (i % 2) { performer_requests_ownKeys(Object(source), true).forEach(function (key) { performer_requests_defineProperty(target, key, source[key]); }); } else if (Object.getOwnPropertyDescriptors) { Object.defineProperties(target, Object.getOwnPropertyDescriptors(source)); } else { performer_requests_ownKeys(Object(source)).forEach(function (key) { Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key)); }); } } return target; }

function performer_requests_defineProperty(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }
...
class performer_requests_PerformerPayoutRequestPage extends external_react_["PureComponent"] {
  constructor(props) {
    super(props);
    this.state = {
      limit: 12,
  ...
  onChange(pagination, filters, sorter) {
    ...
    this.setState(Object(utils["i" /* getSearchData */])(pagination, filters, sorter, oldState));
  }
  ...
  render() {
    ...
    return performer_requests_jsx(external_react_default.a.Fragment, null, performer_requests_jsx(head_default.a, null, performer_requests_jsx("title", null, "Performer Payout Request")), performer_requests_jsx("div", {
      className: "payout-request-page"
    }, performer_requests_jsx(page_header["a" /* default */], {
      title: "Performer Payout Request"
    }), performer_requests_jsx(studio_performer_request_table, {
      payouts: data,
      searching: searching,
      total: total,
...
performer_requests_defineProperty(performer_requests_PerformerPayoutRequestPage, "authenticate", 'studio');

performer_requests_defineProperty(performer_requests_PerformerPayoutRequestPage, "layout", 'primary');

const mapStateToProps = state => performer_requests_objectSpread({}, state.studio.performerRequests);

const mapDispatch = {
  getPerformerRequest: actions["i" /* getPerformerRequest */]
};
/* harmony default export */ var performer_requests = __webpack_exports__["default"] = (Object(external_react_redux_["connect"])(mapStateToProps, mapDispatch)(performer_requests_PerformerPayoutRequestPage));
