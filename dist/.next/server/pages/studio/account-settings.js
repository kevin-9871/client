...
module.exports = __webpack_require__("OMbQ");
...
// EXTERNAL MODULE: ./src/components/studio/index.less
var components_studio = __webpack_require__("avAk");
...
// CONCATENATED MODULE: ./src/components/studio/account-information.tsx
...
const StudioInformation = ({
  ...
  const [certificateId, setCertificateId] = external_react_["useState"](documentVerificationId);
  const [certificate, setCertificate] = external_react_["useState"]([]);
  ...
  return __jsx(external_antd_["Form"], _extends({}, formItemLayout, {
  ...
  })), __jsx(external_antd_["Form"].Item, null, __jsx(external_antd_["Upload"], {
    showUploadList: {
    ...
    listType: "text",
    action: services["s" /* studioService */].getDocumentsUploadUrl(),
    onChange: onCertificateChange
  }, __jsx(external_antd_["Button"], {
    type: "primary"
  }, __jsx(icons_["UploadOutlined"], null), ' ', "Upload Company registration certificate")))), __jsx(external_antd_["Col"], {
    sm: 12,
    xs: 24
  }, __jsx(external_antd_["Form"].Item, {
    name: "country",
...
/* harmony default export */ var account_information = (StudioInformation);
...
// CONCATENATED MODULE: ./pages/studio/account-settings.tsx
...
class account_settings_StudioProfilePage extends external_react_["PureComponent"] {
  ...
  componentDidUpdate(prevProps, prevStates) {
    ...
    if (prevProps.errorInfo !== errorInfo && errorInfo) {
      external_antd_["message"].error(Object(utils["h" /* getResponseError */])(errorInfo));
    }
  ...
  onFinish(data) {
    ...
    dispatchUpdateStudio(account_settings_objectSpread(account_settings_objectSpread({}, Object(external_lodash_["omit"])(studio, ['bankTransferOption', 'bitpay'])), data));
  }
  ...
  onPasswordChange(data) {
    ...
    dispatchUpdatePassword(account_settings_objectSpread({
      source: 'studio'
    }, data));
  }
  ...
  async getPaymentInformation() {
    ...
    payment_information_service["a" /* paymentInformationService */].findOne({
  ...
  async submitPaymentInfoForm(data) {
    try {
      ...
      const resp = await payment_information_service["a" /* paymentInformationService */].create(account_settings_objectSpread({
        type: paymentInformationKey
      }, data));
      this.setState({
        paymentInformation: {
  ...
  render() {
    ...
    return account_settings_jsx(external_react_default.a.Fragment, null, account_settings_jsx(head_default.a, null, account_settings_jsx("title", null, "Account Settings")), account_settings_jsx("div", {
    ...
    }, account_settings_jsx(account_information, account_settings_extends({}, studio, {
      countries: countries,
      ...
      key: "change-password",
      tab: "Change Password"
    }, account_settings_jsx(password_change["a" /* default */], {
      onFinish: this.onPasswordChange.bind(this),
      submiting: updating
    })), account_settings_jsx(external_antd_["Tabs"].TabPane, {
      tab: "(%) Commission",
      key: "commission"
    }, account_settings_jsx(commission_card["b" /* default */], {
      role: commission_card["a" /* ROLE */].STUDIO
    })), account_settings_jsx(external_antd_["Tabs"].TabPane, {
...
account_settings_defineProperty(account_settings_StudioProfilePage, "authenticate", true);

account_settings_defineProperty(account_settings_StudioProfilePage, "layout", 'primary');
...
const mapDispatch = {
  updateStudio: actions["C" /* updateStudio */],
  updateStudioPaymentInfo: actions["H" /* updateStudioPaymentInfo */],
  updateStudioDirectDeposit: actions["E" /* updateStudioDirectDeposit */],
  updateStudioPaxum: actions["G" /* updateStudioPaxum */],
  updateStudioBitpay: actions["D" /* updateStudioBitpay */],
  updatePassword: auth_actions["s" /* updatePassword */]
};
/* harmony default export */ var account_settings = __webpack_exports__["default"] = (Object(external_react_redux_["connect"])(mapStates, mapDispatch)(account_settings_StudioProfilePage));
