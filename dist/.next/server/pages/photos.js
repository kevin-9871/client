...
/* harmony import */ var _redux_photos_actions__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__("8eF+");
/* harmony import */ var _redux_user_actions__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__("x7is");
/* harmony import */ var react_responsive_carousel__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__("KaAA");
...
/* harmony import */ var pages_error__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__("D4/9");
/* harmony import */ var src_lib__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__("psLn");
/* harmony import */ var src_services__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__("CLrh");
/* harmony import */ var _index_less__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__("OG6b");
...
/* harmony import */ var _components_performer_assets_common_modal_buy_assets__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__("04bX");
/* harmony import */ var _components_common_base_loader__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__("TW7V");
/* harmony import */ var _components_common_layout_numberformat__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__("TXU+");
...
const ListItem = ({
  description,
  title
}) => __jsx(antd__WEBPACK_IMPORTED_MODULE_0__["List"].Item, null, __jsx(antd__WEBPACK_IMPORTED_MODULE_0__["Row"], {
  style: {
    width: '100%'
  }
...
}, title), __jsx(antd__WEBPACK_IMPORTED_MODULE_0__["Col"], {
  style: {
    fontWeight: 'bold'
  },
  sm: {
...
class PhotosPages extends react__WEBPACK_IMPORTED_MODULE_3__["PureComponent"] {
  static async getInitialProps({
    ...
    try {
      ...
      if (query.id) {
        ...
        const resp = await src_services__WEBPACK_IMPORTED_MODULE_12__[/* galleryService */ "e"].publicdetails(query.id, headers);
        return {
          data: resp.data,
          isBrowser: false
        };
  ...
  async getGalleryDetail() {
    ...
    try {
      const resp = await src_services__WEBPACK_IMPORTED_MODULE_12__[/* galleryService */ "e"].publicdetails(data._id);
      this.setState({
        gallery: resp.data,
        success: true
      });
  ...
  async getPhotosByGallery() {
    ...
    try {
      ...
      const resp = await src_services__WEBPACK_IMPORTED_MODULE_12__[/* photoService */ "l"].searchByGallery(data._id, {
        limit,
        offset
      });
      this.setState({
  ...
  async responseError(e) {
    ...
    antd__WEBPACK_IMPORTED_MODULE_0__["message"].error(Object(src_lib__WEBPACK_IMPORTED_MODULE_11__[/* getResponseError */ "j"])(err));
  }
  ...
  render() {
    ...
    if (!data) return __jsx(pages_error__WEBPACK_IMPORTED_MODULE_10__["default"], {
      statusCode: 404
    });
    const {
      name,
    ...
    const dataSource = [{
      ...
      title: 'Price',
      description: !isSale ? 'Free' : __jsx(_components_common_layout_numberformat__WEBPACK_IMPORTED_MODULE_16__[/* default */ "a"], {
        value: token,
        suffix: " tokens"
      })
    }];
    return __jsx(react__WEBPACK_IMPORTED_MODULE_3___default.a.Fragment, null, __jsx(next_head__WEBPACK_IMPORTED_MODULE_2___default.a, null, __jsx("title", null, " Photos ")), __jsx(_components_performer_assets_common_modal_buy_assets__WEBPACK_IMPORTED_MODULE_14__[/* default */ "a"], _extends({
      ref: ref => this.buyAssetsRef = ref,
      onSucess: this.onSucess.bind(this)
    }, this.props)), __jsx("div", {
      className: "photo-page"
    }, __jsx(_components_common_layout_page_header__WEBPACK_IMPORTED_MODULE_1__[/* default */ "a"], {
      title: `${Object(src_lib__WEBPACK_IMPORTED_MODULE_11__[/* capitalizeFirstLetter */ "a"])(name)} Gallery`,
      extra: __jsx(antd__WEBPACK_IMPORTED_MODULE_0__["Button"], {
        type: "primary",
    ...
    }, searching && __jsx(_components_common_base_loader__WEBPACK_IMPORTED_MODULE_15__[/* default */ "a"], {
      spinning: true,
      fullScreen: false
      ...
      className: "legend"
    }, p.title)))), __jsx(antd__WEBPACK_IMPORTED_MODULE_0__["List"], {
...
const mapDispatchs = {
  getPerformerPhotos: _redux_photos_actions__WEBPACK_IMPORTED_MODULE_5__[/* getPerformerPhotos */ "a"],
  updateCurrentUserBalance: _redux_user_actions__WEBPACK_IMPORTED_MODULE_6__[/* updateCurrentUserBalance */ "o"]
};
/* harmony default export */ __webpack_exports__["default"] = (Object(react_redux__WEBPACK_IMPORTED_MODULE_4__["connect"])(mapStates, mapDispatchs)(PhotosPages));
...
module.exports = __webpack_require__("+Q02");
