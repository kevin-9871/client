...
module.exports = __webpack_require__("jZz8");
...
/* harmony import */ var _components_common_layout_page__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__("Bfpx");
/* harmony import */ var src_lib__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__("psLn");
...
class ResendVeryficationEmail extends react__WEBPACK_IMPORTED_MODULE_0__["PureComponent"] {
  constructor(props) {
    super(props);
    this.state = {
      submiting: false,
  ...
  async submit(data) {
    try {
      ...
      await src_services__WEBPACK_IMPORTED_MODULE_6__[/* authService */ "a"].resendVerificationEmail(data);
      antd__WEBPACK_IMPORTED_MODULE_2__["message"].success('Verification email have been sent. Please check your inbox or spam box!');
    } catch (e) {
      const error = await Promise.resolve(e);
      this.setState({
        error: true,
        errorMessage: Object(src_lib__WEBPACK_IMPORTED_MODULE_5__[/* getResponseError */ "j"])(error)
      });
    }
  }
  ...
  render() {
    ...
    return __jsx(react__WEBPACK_IMPORTED_MODULE_0___default.a.Fragment, null, __jsx(next_head__WEBPACK_IMPORTED_MODULE_3___default.a, null, __jsx("title", null, "Resend Verification Email")), __jsx(_components_common_layout_page__WEBPACK_IMPORTED_MODULE_4__[/* default */ "a"], {
      ...
      layout: "vertical",
      validateMessages: src_lib__WEBPACK_IMPORTED_MODULE_5__[/* validateMessages */ "o"]
    }, __jsx("h1", null, "Resend Verification Email"), __jsx(antd__WEBPACK_IMPORTED_MODULE_2__["Form"].Item, {
      name: "email",
      rules: [{
        required: true,
      ...
      value: "user"
    }, "User"), __jsx(antd__WEBPACK_IMPORTED_MODULE_2__["Select"].Option, {
      value: "performer"
    }, "Performer"), __jsx(antd__WEBPACK_IMPORTED_MODULE_2__["Select"].Option, {
      value: "studio"
    }, "Studio"))), error && __jsx(antd__WEBPACK_IMPORTED_MODULE_2__["Form"].Item, null, __jsx(antd__WEBPACK_IMPORTED_MODULE_2__["Alert"], {
      showIcon: true,
      type: "error",
      ...
      loading: submiting,
      disabled: submiting
    }, "Submit")))), __jsx(_components_common_layout__WEBPACK_IMPORTED_MODULE_8__[/* FormRegisterPlaceHolder */ "a"], {
      ui: ui
    })));
  }
...
/* harmony default export */ __webpack_exports__["default"] = (Object(react_redux__WEBPACK_IMPORTED_MODULE_7__["connect"])(mapStateToProps)(ResendVeryficationEmail));
